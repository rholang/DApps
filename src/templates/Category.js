...
function make(data, pathContext, param) {
  return /* record */[
          ...
          /* render */(function (_self) {
              return ReasonReact.element(undefined, undefined, CollectionPage.make(pathContext.category, Graphql.getNodes(data.packages), /* array */[]));
            }),
