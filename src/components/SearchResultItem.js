...
function make($$package, isFocused, onClick, param) {
  return /* record */[
              ...
              return React.createElement("div", {
                          ...
                          onClick: (function (_e) {
                              return Curry._1(onClick, $$package);
                                ...
                                }, Vrroom.text($$package.version)), ReasonReact.element(undefined, undefined, Platforms.make($$package.platforms, /* array */[])), React.createElement("div", {
                                  className: TypedGlamor.toString(SearchResultItemStyles.description)
                                }, ReasonReact.element(undefined, undefined, Flags.make($$package, undefined, /* array */[])), Vrroom.text($$package.description))), React.createElement("div", undefined, React.createElement("div", undefined, React.createElement("span", {
                                      className: TypedGlamor.toString(SearchResultItemStyles.stars)
                                    }, (match == null) ? Vrroom.text("-") : Vrroom.text(match), ReasonReact.element(undefined, undefined, Icon.Star[/* make */0](TypedGlamor.toString(SearchResultItemStyles.starIcon), /* array */[]))), ReasonReact.element(undefined, undefined, Score.make($$package, /* array */[]))), React.createElement("div", {
                                  className: TypedGlamor.toString(SearchResultItemStyles.updated)
                                }, ReasonReact.element(undefined, undefined, TimeAgo.make($$package.updated, /* array */[])))));
            }),
