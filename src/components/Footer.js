              ...
              return React.createElement("div", {
                          className: TypedGlamor.toString(FooterStyles.root(context))
                              ...
                              className: TypedGlamor.toString(CommonStyles.widthContainer)
                                            ...
                                            }, Vrroom.text("Support / Bug Tracker"))))), React.createElement("section", undefined, React.createElement("h1", undefined, Vrroom.text("Made with")), React.createElement("ul", undefined, React.createElement("li", undefined, React.createElement("a", {
                                              href: "https://npms.io/"
