...
function make($$package, param) {
  return /* record */[
          ...
          /* render */(function (_self) {
              return ReasonReact.element(undefined, undefined, Tooltip.make(React.createElement("div", {
                                ...
                                }, Vrroom.text(formatPercentage($$package.score)), ReasonReact.element(undefined, undefined, Icon.Verified[/* make */0](Caml_option.some(ScoreStyles.icon), /* array */[])))));
            }),
