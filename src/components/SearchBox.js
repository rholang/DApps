...
function make($staropt$star, param) {
  var focusOnMount = $staropt$star !== undefined ? $staropt$star : false;
  return /* record */[
          ...
          /* didMount */(function (param) {
              ...
              state[/* searchClient */0].on("result", (function (results, param) {
          ...
          /* render */(function (param) {
              ...
              return React.createElement("div", {
                          className: TypedGlamor.toString(SearchBoxStyles.root)
                              ...
                              className: TypedGlamor.toString(SearchBoxStyles.fakeInput)
                            }, ReasonReact.element(undefined, undefined, Icon.Search[/* make */0](Caml_option.some(SearchBoxStyles.searchIcon), /* array */[])), React.createElement("input", {
                                  ref: Curry._1(param[/* handle */0], (function (r, param) {
                                          param[/* state */1][/* inputRef */4][0] = (r == null) ? undefined : Caml_option.some(r);
                                          return /* () */0;
                                        })),
                                ...
                                })), ReasonReact.element(undefined, undefined, Curry._2(Vrroom.Control[/* If */2][/* make */1], Rebase.$$Array[/* length */16](state[/* results */2]) > 0, (function (param) {
                                    return React.createElement("div", {
                                                className: TypedGlamor.toString(SearchBoxStyles.results)
                                              }, ReasonReact.element(undefined, undefined, Curry._3(Vrroom.Control[/* Map */0][/* make */1], state[/* results */2], undefined, (function ($$package) {
                                                          return ReasonReact.element($$package.id, undefined, SearchResultItem.make($$package, Rebase.$$Option[/* exists */9]((function ($$this) {
