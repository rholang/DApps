...
var overlay = TypedGlamor.shadow(TypedGlamor.ex(1), TypedGlamor.ex(1), Caml_option.some(TypedGlamor.em(1)), undefined, undefined, TypedGlamor.rgba(0, 0, 0, 0.1));

var panel = TypedGlamor.shadow(TypedGlamor.px(1), TypedGlamor.px(1), undefined, Caml_option.some(TypedGlamor.px(1)), undefined, TypedGlamor.rgba(0, 0, 0, 0.05));
